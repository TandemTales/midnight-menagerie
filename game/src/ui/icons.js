...
const STATUS = {
  ...
  /* Wisp: a small flame with a halo, so Glow reads as light rather than heat. */
  glow: 'M12 1.4c2.6 3.4 4.6 6 4.6 8.6 0 2.7-2.1 4.6-4.6 4.6s-4.6-1.9-4.6-4.6c0-2.6 2-5.2 4.6-8.6zm0 4.4c-1.3 1.8-2.2 3.1-2.2 4.2a2.2 2.2 0 0 0 4.4 0c0-1.1-.9-2.4-2.2-4.2zM4.6 16.8l1.8-1.4 1.6 2-1.8 1.4zm13 .6 1.6-2 1.8 1.4-1.6 2zM11 18.4h2v3.2h-2z',
  ...
  /* Brambleboo. The Garden set shares a plant-in-a-pot silhouette; the four
     Cultivars are their own shapes so a Garden rail of four chips is readable
     at a glance. `vines`, `entwine` and `snare` are the same coil tightening. */
  garden: 'M12 2.2c2.6 1.8 4 4 4 6.2 0 1.6-.6 2.9-1.6 3.8h2.8l-1.4 9.6H8.2L6.8 12.2h2.8C8.6 11.3 8 10 8 8.4c0-2.2 1.4-4.4 4-6.2zm0 3.4c-1.2 1.3-1.8 2.4-1.8 3.4a1.8 1.8 0 0 0 3.6 0c0-1-.6-2.1-1.8-3.4z',
  ivy: 'M4.2 21.6V6.4h2.2v15.2zM6.4 7.4c3.4 0 5.6 1.8 5.6 4.4s-2.2 4.4-5.6 4.4zm0 2.2v4.4c2 0 3.4-.9 3.4-2.2s-1.4-2.2-3.4-2.2zM17.6 3.6c0 3.2-1.6 5.2-4 5.6 2.4.4 4 2.4 4 5.6-3.2 0-5.2-1.6-5.6-4-.4 2.4-2.4 4-5.6 4 0-3.2 1.6-5.2 4-5.6-2.4-.4-4-2.4-4-5.6 3.2 0 5.2 1.6 5.6 4 .4-2.4 2.4-4 5.6-4z',
  briar: 'M11 22V4.6h2V22zM12 3 14.6 7h-5.2zM12.8 8.6l4.4-2.2 1 2-4.4 2.2zm-1.6 3.6-4.4-2.2-1 2 4.4 2.2zm1.6 3.4 4.4-2.2 1 2-4.4 2.2zM3.4 20.6h17.2v2.2H3.4z',
  moonflower: 'M12 1.6a4 4 0 0 1 3.6 5.7A4 4 0 1 1 17 14a4 4 0 0 1-5 3.2A4 4 0 0 1 7 14a4 4 0 1 1 1.4-6.7A4 4 0 0 1 12 1.6zm0 6.4a2.4 2.4 0 1 0 0 4.8 2.4 2.4 0 0 0 0-4.8zM11 17.6h2V23h-2z',
  'grave-moss': 'M5.6 8.4a3.4 3.4 0 0 1 6.4-1.6A3.4 3.4 0 0 1 18.4 8.4a3.2 3.2 0 0 1 .8 6.2H4.8a3.2 3.2 0 0 1 .8-6.2zM3.4 16.6h17.2v2.2H3.4zm2 3.4h13.2v2.2H5.4z',
  harvest: 'M17.6 2.4a5 5 0 0 1-4.4 7.2v3.2l6.4 6.4-1.6 1.6-6.4-6.4-6.4 6.4-1.6-1.6L11 12.8V9.6A5 5 0 0 1 6.6 2.4 5 5 0 0 1 11 8.2h2a5 5 0 0 1 4.6-5.8z',
  uproot: 'M11 2.4h2v9.2h-2zM12 1 14.4 4.6H9.6zM10.8 13.4 6.4 20.4l-1.8-1.2 4.4-7zm2.4 0 4.4 7-1.8 1.2-4.4-7zM11 13.4h2V22h-2z',
  propagate: 'M6.2 3.4a3.2 3.2 0 1 1 0 6.4 3.2 3.2 0 0 1 0-6.4zm0 2.2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zM17.8 3.4a3.2 3.2 0 1 1 0 6.4 3.2 3.2 0 0 1 0-6.4zm0 2.2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zM5.2 10.6h2.2c0 3.4 1.8 5.4 4.6 5.4v2.2c-4.2 0-6.8-3-6.8-7.6zm11.4 0h2.2c0 4.6-2.6 7.6-6.8 7.6V16c2.8 0 4.6-2 4.6-5.4zM11 17.6h2V23h-2z',
  compost: 'M4.6 8.4h14.8l-1.4 12.2a2.4 2.4 0 0 1-2.4 2.2H8.4a2.4 2.4 0 0 1-2.4-2.2zM8 3.6c2.4 0 4 1.6 4 4-2.4 0-4-1.6-4-4zm8 0c0 2.4-1.6 4-4 4 0-2.4 1.6-4 4-4zM3.2 6h17.6v2H3.2z',
  vines: 'M4.4 2.4c4.4 0 6.6 2.4 6.6 6s-2.2 4.4-2.2 6.6 1.6 3.4 4.2 3.4v2.2c-4 0-6.4-2.2-6.4-5.6 0-3 2.2-4 2.2-6.6 0-2.2-1.4-3.8-4.4-3.8zM19.6 21.6c-4.4 0-6.6-2.4-6.6-6s2.2-4.4 2.2-6.6-1.6-3.4-4.2-3.4V3.4c4 0 6.4 2.2 6.4 5.6 0 3-2.2 4-2.2 6.6 0 2.2 1.4 3.8 4.4 3.8z',
  entwine: 'M11 1.4h2v21.2h-2zM12 4.6c3 0 5 1.6 5 4s-2 4-5 4-5-1.6-5-4 2-4 5-4zm0 2.2c-1.8 0-2.8.8-2.8 1.8S10.2 10.4 12 10.4s2.8-.8 2.8-1.8S13.8 6.8 12 6.8zM12 12.2c3 0 5 1.6 5 4s-2 4-5 4-5-1.6-5-4 2-4 5-4zm0 2.2c-1.8 0-2.8.8-2.8 1.8s1 1.8 2.8 1.8 2.8-.8 2.8-1.8-1-1.8-2.8-1.8z',
  snare: 'M12 1.8c4 0 6.8 2.4 6.8 5.8 0 2.6-1.6 4.4-4 5.2l2.8 8.4-2.1.7-2.7-8.1h-1.6l-2.7 8.1-2.1-.7 2.8-8.4c-2.4-.8-4-2.6-4-5.2 0-3.4 2.8-5.8 6.8-5.8zm0 2.2c-2.8 0-4.6 1.5-4.6 3.6s1.8 3.6 4.6 3.6 4.6-1.5 4.6-3.6S14.8 4 12 4z',
  overgrown: 'M3.4 20.4c0-4 2-6.4 5-6.4v2.2c-1.8 0-2.8 1.4-2.8 4.2zM8.4 20.4c0-6 2-9.6 5-9.6V13c-1.8 0-2.8 2.6-2.8 7.4zM13.4 20.4c0-8 2-12.6 5-12.6v2.2c-1.8 0-2.8 3.8-2.8 10.4zM2.6 21.4h18.8v2.2H2.6zM6.6 2.4c1.8 1.2 2.6 2.6 2.6 4 0 1.6-1.2 2.8-2.6 2.8S4 8 4 6.4c0-1.4.8-2.8 2.6-4zm10.8 0c1.8 1.2 2.6 2.6 2.6 4 0 1.6-1.2 2.8-2.6 2.8s-2.6-1.2-2.6-2.8c0-1.4.8-2.8 2.6-4z',
  weed: 'M11 8.4h2V22h-2zM12 22c0-5.4-2.2-8.6-6-8.6 0 5.4 2.2 8.6 6 8.6zm0 0c0-5.4 2.2-8.6 6-8.6 0 5.4-2.2 8.6-6 8.6zM12 1.6c1.6 2 2.4 3.6 2.4 5 0 1.6-1.1 2.6-2.4 2.6S9.6 8.2 9.6 6.6c0-1.4.8-3 2.4-5zM2.6 21.6h18.8v2.2H2.6z',
  /* Crinkle. `paper` is a sheet with a turned corner; `fold` and `crease` are
     the same sheet with one and two fold lines through it; `overfolded` is the
     folded crow itself, all straight edges; `trace` is two sheets offset;
     `refold` a sheet mid-rotation. The set reads as one stack of paper. */
  paper: 'M5.4 2.4h9.2l4 4v15.2H5.4zm9 1.8V7h2.8zM7.6 10.4h8.8v1.8H7.6zm0 3.6h8.8v1.8H7.6zm0 3.6h5.6v1.8H7.6z',
  fold: 'M5.4 2.4h9.2l4 4v15.2H5.4zm9 1.8V7h2.8zM5.4 12h13.2v1.8H5.4zm1.6-3 3.6 3-3.6 3z',
  crease: 'M5.4 2.4h9.2l4 4v15.2H5.4zm9 1.8V7h2.8zM5.4 9.6h13.2v1.6H5.4zm0 5h13.2v1.6H5.4z',
  overfolded: 'M12 1.8 21.4 8l-4.2 2.6 4.2 3-9.4 8.6L2.6 13.6l4.2-3L2.6 8zm0 2.6L6.6 7.8l5.4 3.4 5.4-3.4zm0 9-4-2.4-2.2 1.4 6.2 5.6 6.2-5.6-2.2-1.4z',
  trace: 'M3.4 5.2h8.2l3.4 3.4v10.2H3.4zm8 1.6v2.4h2.4zM8.6 2.4h8.2l3.4 3.4v10.2h-3.4V8.2L12.8 3.6H8.6z',
  refold: 'M12 3.4a8.6 8.6 0 0 1 8.4 6.8h-2.3A6.4 6.4 0 0 0 12 5.6V8L7.4 4.7 12 1.4zM12 20.6a8.6 8.6 0 0 1-8.4-6.8h2.3A6.4 6.4 0 0 0 12 18.4V16l4.6 3.3L12 22.6zM9.4 8.6h5.2l2 2v5.2H9.4zm5 1.4v1.2h1.2z',
