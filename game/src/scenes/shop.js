...
<svg class="sh-moth" viewBox="0 20 120 232" preserveAspectRatio="xMidYMax slice" role="img" aria-label="Mr. Moth, behind his counter">
  ...
  <g class="sh-moth__fig" filter="url(#shBrush)">
    <g class="sh-moth__wings">
      ...
      <!-- a pale band across each forewing and dusky tips, the markings a real moth wears -->
      <path class="sh-moth__band" d="M30 88 C24 78 20 70 18 60 C24 62 30 66 34 72 C38 78 42 86 44 94 C40 94 34 92 30 88Z"/>
      <path class="sh-moth__band" d="M90 88 C96 78 100 70 102 60 C96 62 90 66 86 72 C82 78 78 86 76 94 C80 94 86 92 90 88Z"/>
      <path class="sh-moth__tip" d="M7 52 C3 45 8 39 15 42 C20 44 24 47 27 50 C20 52 12 54 7 52Z"/>
      <path class="sh-moth__tip" d="M113 52 C117 45 112 39 105 42 C100 44 96 47 93 50 C100 52 108 54 113 52Z"/>
      <g class="sh-moth__dots"><circle cx="20" cy="150" r="1.5"/><circle cx="24" cy="164" r="1.3"/><circle cx="31" cy="172" r="1.2"/><circle cx="100" cy="150" r="1.5"/><circle cx="96" cy="164" r="1.3"/><circle cx="89" cy="172" r="1.2"/></g>
    ...
    <ellipse class="sh-moth__halo" cx="60" cy="86" rx="28" ry="26"/>
