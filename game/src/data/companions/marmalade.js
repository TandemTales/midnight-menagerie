...
const commons = [
  ...
  },
  {
    ...
    cost: 2, target: ENEMY, text: 'Deal {d} damage. Apply {n} Weak.',
  ...
  },
  {
    ...
    cost: 0, target: ENEMY, keywords: [HAUNT],
...
const uncommons = [
  ...
  },
  {
    ...
    cost: 4, target: ENEMY, keywords: [GHOST],
    ...
    dynamicCost: (c) => Math.max(0, 4 - U.res(c, GHOST)),
    upgrade: { nums: { d: 38, n: 1 } },
  },
  {
  ...
  },
  {
    ...
    cost: 2, target: ENEMY, keywords: ['zoomies'],
  ...
  },
  {
    ...
    cost: 0, target: SELF, text: 'Prevent the next {n} negative conditions an enemy would apply to you this turn.',
    flavor: 'She simply declines.',
    nums: { n: 1 }, effect: eff(c => U.applySelf(c, 'nope', N(c).n)), upgrade: { nums: { n: 2 } },
  },
  {
  ...
  },
  {
    ...
    upgrade: { nums: { b: 13, n: 3, m0: 4 } },
  },
  {
    id: 'marmalade/hairball', name: 'Hairball', companion: SLUG, type: SKILL, rarity: UNCOMMON,
    cost: 2, target: ENEMY, text: 'Apply {n} Weak and {m0} Vulnerable.',
  ...
  },
  {
    ...
    cost: 0, target: SELF, text: 'Remove a negative condition from yourself. Gain {b} Guard.',
  ...
  },
  {
    ...
    cost: 2, target: SELF, keywords: ['lives', HAUNT],
    ...
    upgrade: { nums: { b: 22, n: 4, m0: 14, m1: 2, m2: 1 } },
  },
...
const rares = [
  ...
  },
  {
    ...
    upgrade: { nums: { m0: 3, n: 28, b: 32, m1: 2 } },
  },
  {
