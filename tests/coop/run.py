"""Run the co-op combat assertion suite in a real browser and print the result.

    python tests/coop/run.py [--wait 4] [--verbose]
...
URL = "http://localhost:8777/tests/coop/index.html"
