"""Pudding's signature systems, asserted against the real engine.

    python tests/pudding/run.py
...
the Trick really left the deck for a Plot, the Plot really refused a second
operation in one turn, Unearthed really doubled the damage.
"""
import sys
from playwright.sync_api import sync_playwright

URL = "http://localhost:8777/tests/pudding/index.html"
