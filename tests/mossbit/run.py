"""Mossbit's signature systems, asserted against the real engine.

    python tests/mossbit/run.py
...
the Epitaph really resolved on schedule, hurrying one really forfeited the
Patience, and the Buried Harm really came due a turn later through Guard.
"""
import sys
from playwright.sync_api import sync_playwright

URL = "http://localhost:8777/tests/mossbit/index.html"
