"""Run the combat engine assertion suite in a real browser and print the result.

    python tests/combat/run.py [--wait 4] [--verbose]
...
URL = "http://localhost:8777/tests/combat/index.html"
