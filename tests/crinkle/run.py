"""Crinkle's signature systems, asserted against the real engine.

    python tests/crinkle/run.py
...
the Crease really survived a trip through the piles, the Overfolded Trick
really dealt double and really left the fight, the copy really Vanished.
"""
import sys
from playwright.sync_api import sync_playwright

URL = "http://localhost:8777/tests/crinkle/index.html"
