"""Drizzle's signature systems, asserted against the real engine.

    python tests/drizzle/run.py
...
the Weather really changed, the Conduct really reached the other Soaked enemy,
the Forecast really left the deck and really came back.
"""
import sys
from playwright.sync_api import sync_playwright

URL = "http://localhost:8777/tests/drizzle/index.html"
