"""Brambleboo's signature systems, asserted against the real engine.

    python tests/brambleboo/run.py
...
the Plant really Matured on schedule, the Harvest really paid and really took
the Plant, and four Vines really Snared the Attack without cancelling it.
"""
import sys
from playwright.sync_api import sync_playwright

URL = "http://localhost:8777/tests/brambleboo/index.html"
